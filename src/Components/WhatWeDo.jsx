    ...
    <>
      <section className="bg-zinc-900 w- md:h-[1050px] h-[795px] min-[350px]:max-[475px]:h-[920px] -translate-y-[400px]  -z-20 md:pr-12  px-10 md:px-0 ">
        <div className="w-full mt-52 md:mt-0 md:translate-y-[350px] translate-y-52 grid grid-cols-1 lg:grid-cols-2 min-[768px]:max-[792px]:grid-cols-1 mx-auto xl:translate-x-12 gap-10 ">
          <div className=" text-left lg:text-right mt-12 md:mt-0  md:ml-48 md:-translate-x-32 lg:-translate-x-0 ">
          ...
          <div className="md:w-[400px] w-full md:translate-x-16 lg:translate-x-0 ">
