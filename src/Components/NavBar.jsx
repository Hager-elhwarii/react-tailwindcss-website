    ...
    <>
      ...
      >
        ...
        <div className="lg:navbar-center w-full lg:w-auto">
          <ul className={` w-full flex justify-end gap-3 lg:mb-0 lg:gap-10 px-1 text-[14px]  ${scrolled ? "md:text-[18px]" : "lg:text-[19.8px]"}`}>
            <li>
            ...
            <li>
              <a className="hover-underline-animation  cursor-pointer">Content</a>
            </li>
            <li>
              <a className="hover-underline-animation  cursor-pointer">System</a>
            </li>
          </ul>
        </div>
        <div className="navbar-end md:mr-32  hidden lg:flex">
          <a className="border border-outline hover:bg-white hover:text-black py-2 px-4 rounded-full cursor-pointer transtion ease-in-out duration-500">
            Download Template
          </a>
        </div>
      </div>
